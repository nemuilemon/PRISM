...
class $AccountsTable extends Accounts with TableInfo<$AccountsTable, Account> {
  ...
  @override
  List<GeneratedColumn> get $columns => [id, name, type, currencyCode, isAsset];
  @override
...
class Account extends DataClass implements Insertable<Account> {
  ...
  @override
  int get hashCode => Object.hash(id, name, type, currencyCode, isAsset);
  @override
...
class $TransactionsTable extends Transactions
  ...
  static const VerificationMeta _emotionalScoreMeta = const VerificationMeta(
    'emotionalScore',
  );
  @override
  ...
  static const VerificationMeta _emotionalTagMeta = const VerificationMeta(
    'emotionalTag',
  );
  @override
  late final GeneratedColumn<String> emotionalTag = GeneratedColumn<String>(
    'emotional_tag',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _investmentFlagMeta = const VerificationMeta(
    'investmentFlag',
  );
  @override
  late final GeneratedColumn<bool> investmentFlag = GeneratedColumn<bool>(
    'investment_flag',
    aliasedName,
    false,
    type: DriftSqlType.bool,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('emotional_tag')) {
      context.handle(
        _emotionalTagMeta,
        emotionalTag.isAcceptableOrUnknown(
          data['emotional_tag']!,
          _emotionalTagMeta,
        ),
      );
    }
    if (data.containsKey('investment_flag')) {
      context.handle(
        _investmentFlagMeta,
        investmentFlag.isAcceptableOrUnknown(
          data['investment_flag']!,
          _investmentFlagMeta,
        ),
      );
    }
  ...
  Transaction map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Transaction(
      ...
      emotionalScore: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}emotional_score'],
      )!,
      emotionalTag: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}emotional_tag'],
      ),
      investmentFlag: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
...
class Transaction extends DataClass implements Insertable<Transaction> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || emotionalTag != null) {
  ...
  TransactionsCompanion toCompanion(bool nullToAbsent) {
    return TransactionsCompanion(
      ...
      emotionalTag: emotionalTag == null && nullToAbsent
          ? const Value.absent()
          : Value(emotionalTag),
  ...
  Transaction copyWithCompanion(TransactionsCompanion data) {
    return Transaction(
      ...
      emotionalScore: data.emotionalScore.present
          ...
          : this.emotionalScore,
      emotionalTag: data.emotionalTag.present
          ? data.emotionalTag.value
          : this.emotionalTag,
...
class TransactionsCompanion extends UpdateCompanion<Transaction> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (emotionalTag.present) {
      map['emotional_tag'] = Variable<String>(emotionalTag.value);
    }
...
class $$TransactionsTableFilterComposer
  ...
  ColumnFilters<String> get emotionalTag => $composableBuilder(
    column: $table.emotionalTag,
    builder: (column) => ColumnFilters(column),
  );
...
class $$TransactionsTableOrderingComposer
  ...
  ColumnOrderings<String> get emotionalTag => $composableBuilder(
    column: $table.emotionalTag,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<bool> get investmentFlag => $composableBuilder(
    column: $table.investmentFlag,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$TransactionsTableAnnotationComposer
  ...
  GeneratedColumn<String> get emotionalTag => $composableBuilder(
    column: $table.emotionalTag,
    builder: (column) => column,
  );

  GeneratedColumn<bool> get investmentFlag => $composableBuilder(
    column: $table.investmentFlag,
    builder: (column) => column,
  );
...
class $$TransactionsTableTableManager
    extends
        RootTableManager<
          ...
          Transaction,
          PrefetchHooks Function({bool accountId, bool transactionTagsRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback:
              ({accountId = false, transactionTagsRefs = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
